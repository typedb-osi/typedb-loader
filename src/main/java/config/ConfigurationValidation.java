...
//                // ATTRIBUTE
//                if (gc && dps) {
//                    valAttributeAttribute(validationReport, breadcrumbs, configuration, attribute.getValue(), attribute.getValue().getInsert(), session);
//                }
//            }
//        }
//
...
//        } else {
//            valConceptTypeInSchema(validationReport, session, breadcrumbs, attribute.getAttribute());
//        }
...
//        boolean valid = true;
//
//        String[] dataPaths = generator.getData();
//
//        // dataPaths missing
//        if (dataPaths == null) {
...
//            } else {
//                valRoleType(validationReport, session, breadcrumbs + ".players.[" + playerIdx + "]", relation.getConceptType(), player.getRole());
//            }
//
//            String pBreadcrumbs = breadcrumbs + ".players." + player.getRole();
//            // requireNonEmpty
...
//
//                Configuration.RoleGetter roleGetter = player.getMatch();
//                // CONCEPT_TYPE
//                if (roleGetter.getAttribute() == null) {
//                    validationReport.get("errors").add(gBreadcrumbs + ".conceptType: missing required field");
//                } else {
//                    valConceptTypeInSchema(validationReport, session, gBreadcrumbs, roleGetter.getAttribute());
//                }
//
//                // HANDLER
...
//                            if (roleGetter.getOwnerships() != null) {
...
//                            valThingGettersEntity(validationReport, breadcrumbs, configuration, relation, roleGetter.getOwnerships(), session);
//                        } else if (roleGetter.getHandler().equals(TypeHandler.RELATION)) {
//                            valThingGettersRelation(validationReport, breadcrumbs, configuration, relation, roleGetter.getOwnerships(), session);
//                        }
//                    }
//                }
//            } else {
...
//                    }
//                    // CONCEPT_TYPE
//                    if (thingGetter.getAttribute() == null) {
//                        validationReport.get("errors").add(tgBreadcrumbs + ".conceptType: missing required field");
//                    } else {
//                        valConceptTypeInSchema(validationReport, session, tgBreadcrumbs, thingGetter.getAttribute());
//                    }
//                    // COLUMN
