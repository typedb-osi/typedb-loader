...
public class EntityInsertGeneratorTest {
    ...
    private final String dataD = getAbsPath("src/test/resources/phone-calls/person.csv");
    private final String dataE = getAbsPath("src/test/resources/phone-calls/company.csv");
    ...
    public void graknEntityQueryFromRowTest() {
        ...
        Assert.assertEquals(32, results.getInserts().size());
    ...
    public void graknEntityQueryFromRowWithBoolAndDoubleTest() {
        ...
        Assert.assertEquals(12, results.getInserts().size());
        results.getInserts().removeAll(Collections.singleton(null));
    ...
    public void graknEntityQueryFromRowPhoneCallsPerson() {
        ...
        Assert.assertEquals(35, results.getInserts().size());
        results.getInserts().removeAll(Collections.singleton(null));
        Assert.assertEquals(32, results.getInserts().size());
